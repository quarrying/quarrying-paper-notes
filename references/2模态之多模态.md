...
## [2022] BLIP
----
BLIP 提出一个名为 CapFilt (Captioning and Filtering) 的方法, 从含噪的图文对中构建 captioning 数据.
...
## Flickr30k, Flickr 30k, Flickr30k entities
-----
图文检索数据集, 目前指标已经刷的很高了.
...
- [2017 IJCV] Flickr30k entities: Collecting region-to-phrase correspondences for richer image-to-sentence models. IJCV 2017
