...
## NMS
- *SoftNMS*: [2017] Improving object detection with one line of code
- *Softer-NMS*: [2018] Softer-NMS_ Rethinking Bounding Box Regression for Accurate Object Detection
- *IOU-Guided NMS*: [2018] Acquisition of Localization Confidence for Accurate Object Detection
- *DIoU NMS*: [2020 AAAI] Distance-IoU Loss_ Faster and better learning for bounding box regression
- [2016] A convnet for nonmaximum suppression
- [2017] Learning non-maximum suppression
- *NMW, Non-maximum weighted*: [2017 ICCV] CAD_ Scale Invariant Framework for Real-Time Object Detection
- *WBF, Weighted boxes fusion*: [2019] Weighted Boxes Fusion_ ensembling boxes for object detection models
...
- *ATSS*: [2020 CVPR] Bridging the gap between anchor-based and anchor-free detection via adaptive training sample selection
...
- *SimOTA*: [2021] Yolox: Exceeding yolo series in 2021
...
## ROI Operation
- *ROI Pooling*: [2015 NeurPS] Faster r-cnn_ Towards real-time object detection with region proposal networks
- RoIWrap Pooling
- *ROIAlign Pooling*: [2017 ICCV] Mask r-cnn
    - [RoIPooling、RoIAlign笔记](https://www.cnblogs.com/wangyong/p/8523814.html)
- PSROI Pooling
- Precise ROI Pooling
- *RoI transform layer*: [2018 ACCV] Textnet_ Irregular text reading from images with an end-to-end trainable network

## Loss
- *IoU loss*: [2016 ACM MM] UnitBox_ An advanced object detection network
- *GIoU loss*: [2019 CVPR] Generalized intersection over union_ A metric and a loss for bounding box regression
- *DIoU loss, CIoU loss*: [2020 AAAI] Distance-IoU Loss_ Faster and better learning for bounding box regression
- [2018 CVPR] Improving object localization with fitness nms and bounded iou loss
- [2019] Iou loss for 2d/3d object detection
- *PIoU Loss*: [2020 ECCV] PIoU Loss_ Towards Accurate Oriented Object Detection in Complex Environments
- *Varifocal Loss, VFL*: [2021 CVPR] Varifocalnet: An iou-aware dense object detector
...
## Detetector Neck
- *FPN*: [2017 CVPR] Feature Pyramid Networks for Object Detection
- *ASFF*, adaptively spatial feature fusion: [2019] Learning Spatial Fusion for Single-Shot Object Detection
    - https://github.com/ruinmessi/ASFF
- *NAS-FPN*: [2019 CVPR] NAS-FPN_ Learning scalable feature pyramid architecture for object detection
- *RFP*: [2020] Detectors_ Detecting objects with recursive feature pyramid and switchable atrous convolution.
- *BiFPN*: [2020 CVPR] Efficientdet: Scalable and efficient object detection
- *PAN*: [2018 CVPR] Path aggregation network for instance segmentation
...
## YOLO Series
- *YOLO*: [2015] You Only Look Once_ Unified, Real-Time Object Detection
    - 可以视作一种 anchor-free 的方法?
- *YOLOv2*: [2016] YOLO9000_ Better, Faster, Stronger
- *YOLOv3*: [2018] YOLOv3_ An Incremental Improvement
    - https://github.com/ultralytics/yolov3
- *Yolo-lite*: [2018] Yolo-lite_ a real-time object detection algorithm optimized for non-gpu computers
- *YOLOv4*: [2020] YOLOv4_ Optimal Speed and Accuracy of Object Detection
    - https://github.com/AlexeyAB/darknet
- *YOLOv5*
    - https://github.com/ultralytics/YOLOv5
- *scaled-YOLOv4*: [2020] Scaled-YOLOv4_ Scaling Cross Stage Partial Network
- https://github.com/byfate/Stronger-yolo-pytorch


## Anchor-free
- *FCOS*: [2019] FCOS_ Fully Convolutional One-Stage Object Detection
    - https://github.com/tianzhi0549/FCOS
- *CenterNet*: [2019] Objects as Points
    - https://github.com/xingyizhou/centernet
- *CornerNet*: [2018 ICCV] CornerNet_ Detecting objects as paired keypoints
    - https://github.com/umich-vl/CornerNet
- *CornerNet-Lite*: [2019] CornerNet-Lite_ Efficient keypoint based object detection
- *RepPoints*:  [2019 ICCV] RepPoints_ Point set representation for object detection
    - two-stage anchor-free detector
- *RepPoints v2*: [2020] RepPoints v2_ Verification Meets Regression for Object Detection


## Detection and NAS
- *DetNAS*: [2019 NeurIPS] DetNAS: Backbone search for object detection
- *NAS-FPN*: [2019 CVPR] NAS-FPN: Learning scalable feature pyramid architecture for object detection
- *NAS-FCOS*: [2019] NAS-FCOS: Fast neural architecture search for object detection
